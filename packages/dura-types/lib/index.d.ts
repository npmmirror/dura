...
export declare type ReducersMapOfStore<S> = JsonObject<
  ReducersMapOfStoreSlice<S>
>;
export declare type StoreSliceMap<
  N extends string,
...
export declare type ExtractStateByStoreUnion<T> = T extends StoreSlice<
  infer N,
  infer S,
  infer R,
  infer E
>
  ...
  : never;
export declare type ExtractAction<T> = ExtractActionByReducer<T> &
  ExtractActionByEffect<T>;
export declare type ExtractActionByReducer<T> = T extends StoreSlice<
  infer N,
  infer S,
  infer R,
  infer E
>
  ...
  : never;
export declare type ExtractActionByEffect<T> = T extends StoreSlice<
  infer N,
  infer S,
  infer R,
  infer E
>
  ...
  : never;
export declare type UnionToIntersection<T> = (
