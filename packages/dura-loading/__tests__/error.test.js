...
describe('测试loading 插件', function () {
    it('测试异常场景下，loading关闭的问题', function () {
        return __awaiter(this, void 0, void 0, function () {
            var user, initialModel, store, getState, dispatch, actionCreator, error_1;
                    ...
                    case 0:
                        user = {
                            ...
                            effects: function () { return ({
                                 ...
                                 * @param param0
                                 */
                                onAsyncChangeName: function (payload, meta) {
                                    return __awaiter(this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                        ...
                        store = plus_1.create({
                            ...
                            loading: index_1.createLoadingPlugin(initialModel)
                        });
                        getState = store.getState, dispatch = store.dispatch;
                        actionCreator = actions_1.default(initialModel);
                        expect(getState().user).toEqual({ name: undefined, sex: undefined });
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, dispatch(actionCreator.user.onAsyncChangeName({ name: '张三' }, { loading: true }))];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
