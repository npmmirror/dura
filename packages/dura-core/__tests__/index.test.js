...
describe('demo', () => {
    ...
    it('dispatch reducers', function () {
        ...
        duraCore.dispatch({type: 'user/reducers/onChangeName', payload: {name: "李四"}})
    ...
    it('dispatch effects', function (done) {
        ...
        const model = {
            ...
            effects: {
                enhanceName: function* ({delay, put}, action) {
                    ...
                    yield put({type: 'user/reducers/onChangeName', payload: {name: newName}})
                }
            }
        }
        ...
        duraCore.dispatch({type: 'user/effects/enhanceName', payload: {name: "李四"}})

        setTimeout(() => {
            expect(duraCore.getState()['user']).toEqual({name: 'enhanceName李四', age: 12})
            done()
        }, 1000)
    ...
    it('array default effect ', function () {
        const defaultModel = {
            ...
            effects: {
                onChangeName: [function* ({put}, action) {
                    yield put({
            ...
            effects: {
                onChangeType: [function* ({put}, action) {
                    yield put({
            ...
            effects: {
                onChangeObject: [function* ({put}, action) {
                    yield put({
            ...
            effects: {
                onChangeEmpty: [function* ({put}, action) {
                    yield put({
    ...
    it('takeLatest effects', function (done) {
        ...
        const takeLatestModel = {
            ...
            effects: {
                onChangeName: [function* ({put, delay}, action) {
                    yield delay(1000)
                    yield put({
        ...
        expect(duraStore.getState()['takeLatest']).toEqual(takeLatestModel.initialState)
        ...
        setTimeout(() => expect(duraStore.getState()['takeLatest']).toEqual(takeLatestModel.initialState), 998)
    ...
    it('takeLeading effects', function (done) {
        ...
        expect(duraStore.getState()['takeLeading']).toEqual(takeLeadingModel.initialState)
        ...
        setTimeout(() => expect(duraStore.getState()['takeLeading']).toEqual(takeLeadingModel.initialState), 998)
    ...
    it('throttle effects', function (done) {
        ...
        expect(duraStore.getState()['throttle']).toEqual(throttleModel.initialState)
        ...
        setTimeout(() => expect(duraStore.getState()['throttle']).toEqual(throttleModel.initialState), 400)
