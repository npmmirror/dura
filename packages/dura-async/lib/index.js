...
function createModelEffectRunner(name, model, dispatch) {
    var _a;
    var _b = model.effects, effects = _b === void 0 ? {} : _b;
    var effectKeys = Object.keys(effects);
    ...
    var action = effectKeys.map(createActionMap).reduce(merge, {});
    return _a = {}, _a[name] = action, _a;
}
//创建全局的action  runner
function createEffectRunner(models, dispatch) {
    var merge = function (prev, next) { return (__assign({}, prev, next)); };
