...
exports.default = {
    ...
    reducers: function () { return ({
        onChangeIsShowDraw: function (state, payload) {
            state.isShowDraw = payload.isShowDraw;
        },
        onChangeIsShow: function (state, payload) {
        ...
        onChangeContext: function (state, payload) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            //   throw new Error();
                            // }
                            dispatch(store_1.actionCreator.user.onChangeName(payload));
                            dispatch(store_1.actionCreator.user.onChangeIsShow({ nextIsShow: true }));
                            return [2 /*return*/];
                    }
                });
            });
